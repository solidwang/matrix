package com.solid4j.matrix.dao;

import com.solid4j.matrix.common.Constants;
import com.solid4j.matrix.orm.EntityHelper;
...
public class SqlHelper {
     ...
     * SQL 属性文件对象
     */
    private static final Properties sqlProps = PropUtil.loadProps(Constants.SQL_PROPS);
    ...
    public static String getSql(String key) {
        ...
        if (sqlProps.containsKey(key)) {
            ...
            throw new RuntimeException("无法在 " + Constants.SQL_PROPS + " 文件中获取属性：" + key);
        }
        return sql;
    }
