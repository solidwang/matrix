package com.solid4j.matrix.orm;


import com.solid4j.matrix.common.Constants;
import com.solid4j.matrix.dao.DatabaseHelper;
import com.solid4j.matrix.dao.SqlHelper;
import com.solid4j.matrix.util.ArrayUtil;
import com.solid4j.matrix.util.ObjectUtil;
...
public class DataSet {
    ...
    public static <T> Map<Long, T> selectMap(Class<T> entityClass) {
        return selectMapWithPK(entityClass, Constants.PK_NAME, "", "");
    }
    ...
    public static <T> Map<Long, T> selectMapWithCondition(Class<T> entityClass, String condition, Object... params) {
        return selectMapWithPK(entityClass, Constants.PK_NAME, condition, "", params);
    }
    ...
    public static <T> Map<Long, T> selectMapWithSort(Class<T> entityClass, String sort) {
        return selectMapWithPK(entityClass, Constants.PK_NAME, "", sort);
    }
    ...
    public static <T> Map<Long, T> selectMapWithConditionAndSort(Class<T> entityClass, String condition, String sort, Object... params) {
        return selectMapWithPK(entityClass, Constants.PK_NAME, condition, sort, params);
    }
    ...
    public static boolean update(Object entity) {
        return update(entity, Constants.PK_NAME);
    }
    ...
    public static boolean delete(Object entityObject) {
        return delete(entityObject, Constants.PK_NAME);
    }
