...
import com.solid4j.matrix.orm.annotation.Column;
import com.solid4j.matrix.orm.annotation.Entity;
import com.solid4j.matrix.orm.annotation.Table;
import com.solid4j.matrix.util.StringUtil;
...
public class EntityHelper {
    ...
    static {
        // 获取并遍历所有实体类
        List<Class<?>> entityClassList = ClassConfig.getClassListByAnnotation(Entity.class);
    ...
    private static void initEntityNameMap(Class<?> entityClass) {
        ...
        if (entityClass.isAnnotationPresent(Table.class)) {
            ...
            tableName = StringUtil.humpToUnderLine(entityClass.getSimpleName());
        }
